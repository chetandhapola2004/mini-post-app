...
export const LogoIcon = ({ className = '', size = 24 }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
    ...
    <path d="M21 16L16 11L7 20" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const FeedIcon = ({ size = 18, className = '' }) => (
...
export const HeartIcon = ({ size = 18, filled = false, className = '' }) => (
